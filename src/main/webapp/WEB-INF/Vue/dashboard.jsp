        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span
                    ...
                    <div class="nav_list"> <a href="<%=request.getContextPath()%>/" class="nav_link active"> <i class='bx bx-home'></i>
                            <span class="nav_name">Departement</span> </a> 
                            <a href="<%=request.getContextPath()%>/Filier" class="nav_link"> <i class='bx bx-file-blank'></i> <span class="nav_name">Filiere</span> </a>
                                 <a href="<%=request.getContextPath()%>/Etudiant"
                            class="nav_link"> <i class='bx bxs-user'></i> <span
                                class="nav_name">Etudiant</span> </a>
                    </div>
